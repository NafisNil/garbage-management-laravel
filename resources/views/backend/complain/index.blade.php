                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{(!empty($item->logo))?URL::to('storage/'.$item->logo):URL::to('image/no_image.png')}}"><img src="{{(!empty($item->logo))?URL::to('storage/'.$item->logo):URL::to('image/no_image.png')}}" alt="" style="max-width:150px"></a></td>
                      <td>
                        @if ($item->status == '0') 
                        <span class="badge bg-secondary">Pending</span>
                           
                          @elseif ($item->status == '1')
                          <span class="badge bg-warning">Assigned to the vendor</span>
                          @elseif ($item->status == '2')
                          <span class="badge bg-success">Resolved by the vendor</span>
                            @endif
                      </td>
                      <td>
                        ...
                        <a href="{{ route('complain.assigned', $item->id) }}" class="btn btn-outline-warning btn-sm">Assign To Vendor</a>
                        <a href="{{ route('complain.completed', $item->id) }}" class="btn btn-outline-success btn-sm">Done</a>
