...
<div class="container mt-4">
    ...
    <div class="card mt-3">
        <div class="card-body">
            <h6>Bill amount</h6>
            <h4 class="text-success fw-bold">{{ $bill->amount }} TK <span class="text-muted fs-6">Paid</span></h4>
            <p class="mb-1">Paid by  : </p>
            <p class="mb-1">Payment Date: <span class="text-success">{{ $bill->created_at->format('d M, Y') }}</span></p>
